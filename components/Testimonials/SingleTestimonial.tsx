  ...
  return (
    <div className="w-full">
      ...
      >
        ...
        <p className="min-h-[120px] mb-8 border-b border-body-color border-opacity-10 pb-8 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-10 dark:text-white">
          “{content}“
        </p>
